...
class CarlaEvalEnvs3(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.ct=0
        self.prev_angle=0.0
        self.global_model = torch.load("/data/carla/PythonAPI/vi_experiment_env_latency_07122023/model_10_11_RegNet.pth")
        self.model=torch.load("/data/carla/PythonAPI/vi_experiment_env_latency_07122023/model_reg_s3_worst_worst.pth")
        ...
        # self.target_wp = carla.Location(x=-38.668877,y=48.905540,z=0.6)
        ...
        self.result = cv2.VideoWriter("rollout_ablation_emb_24_02_s3.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
    ...
    def local_policy(self, image, location):
        ...
        # self.action_list = np.vstack((self.action_list, np.array([angle,speed,0.0])))
        ...
        res=self.model(img_tensor.to(torch.device('cuda:3')), location_tensor.to(torch.device('cuda:3')))
    ...
    def close(self):
        ...
        df.to_csv('task_metrics_ablation_emb_24_02_s3.csv',index=False)
