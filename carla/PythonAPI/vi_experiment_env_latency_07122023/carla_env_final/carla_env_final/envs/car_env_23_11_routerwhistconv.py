...
class CarlaEnvrouterwhistconv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.model=torch.load("/data2/kathakoli/carla/PythonAPI/vi_experiment_env_latency_07122023/CVPR_customLinear_21_11_data_08_11_epoch80_lr1emin4_nopretrain_parallel.pth")
    ...
    def get_reward(self,collision, action,geodesic,dir_r, energy):
        ...
        if collision!=0 and action[1]>1e-5:
            ...
            #print("Diya")
            #return geodesic_rw
        return (geodesic_rw*energy_dis*extreme_actions_reward)**(1.0/3.0)
