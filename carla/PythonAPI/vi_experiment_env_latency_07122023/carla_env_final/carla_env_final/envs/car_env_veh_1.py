...
class CarlaEnvveh1(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.gm=torch.load("local_model_veh_2.pth")
    ...
    def reset(self,seed=None, options=None):
        ...
        if(self.count>1):
            ...
            self.vehicles_list = util.spawn_vehicles(self.client, self.world.world, 30, True, self.traffic_manager)
            # batch = []
            # controller_list = []
            # controller_bp = self.world.world.get_blueprint_library().find('controller.ai.walker')
