...
class CarlaEnvrebuttalCVPR2(gym.Env):
    ...
    def get_reward(self,collision, action,geodesic,dir_r, energy):
        ...
        if collision!=0 and action[1]>1e-5:
            ...
            #print(geodesic_rw)
            #speed=(action[0][1])/2x
            energy_dis=(1.0-energy/3.25)#Flop/Max Flop
    ...
    def _step(self, action):#0- Local Policy #1- Global Policy
        ...
        print(self.controller._control.direction, self.controller._control.speed)
    ...
    #     self.route_deviation = np.linalg.norm(ego_world_pos - local_goal)
        ...
        #     self.route_deviation = np.linalg.norm(ego_world_pos - local_goal)
            ...
            print(self.local_step_counter, self.global_step_counter)
            self.task_metrics.append([self.count_epi,self.col_count,self.route_completion,self.local_step_counter, self.global_step_counter])
