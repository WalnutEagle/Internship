...
class CarlaEnvrouters1(gym.Env):
    ...
    def pre_act(self):
        ...
        for i in self.pedestrian_list:
            ...
            if self._get_actor_distance(i, player_pos)<4 and self._get_actor_direction(i, player_pos)!=None:
                self.ped_count+=1
            if self._get_actor_distance(i, player_pos)<8 and self._get_actor_direction(i, player_pos)!=None:
                ped_id.append(i)
        ...
        return a,pedestrian_detected,energy,waypt,ped_id
    def _get_obs(self):
    ...
    def get_reward(self,collision, action,geodesic,dir_r, energy):
        ...
        if collision!=0 and action[1]>1e-5:
            ...
            #print("Diya")
            #return geodesic_rw
        return (geodesic_rw+speed+energy_dis)*(1.0/3.0)
    ...
    def _step(self, action):#0- Local Policy #1- Global Policy
        ...
        #action=obs[0][-1][:2]
        #obs = self._get_obs()
        a, pedestrian_detected,energy,waypt, ped_id=self.pre_act()
