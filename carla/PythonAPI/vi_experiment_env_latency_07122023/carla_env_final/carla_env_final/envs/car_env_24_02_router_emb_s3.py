...
class CarlaEnvrouters3(gym.Env):
    ...
    def observation_space(self, *args, **kwargs):
        ...
        # list1=[-1.0]*48+[-3.14, 0.0,0.0]
        # list2=[1.0]*48+[3.14, 2.0,1.0]
    ...
    def action_space(self):
        ...
        #return spaces.Box(low=np.array([0.0]), high=np.array([1.0]), dtype=np.float64)
        return spaces.Box(low=np.array([0,-3.14,0.0]),high=np.array([1,3.14,2.0]))
    ...
    def reset(self,seed=None, options=None):
        ...
        # self.world.tick(self.clock)
        self.a, self.pedestrian_detected,self.energy,self.waypt=self.pre_act()
