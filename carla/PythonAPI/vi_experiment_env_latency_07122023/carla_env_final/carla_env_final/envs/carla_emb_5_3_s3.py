...
class CarlaEnvrouters1(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        #print("Sleep")
        self.model=torch.load("/data/carla/PythonAPI/vi_experiment_env_latency_07122023/CVPR_mobilevitXXS_21_11_data_08_11_epoch200_lr1emin2_nopretrain_parallel.pth")
