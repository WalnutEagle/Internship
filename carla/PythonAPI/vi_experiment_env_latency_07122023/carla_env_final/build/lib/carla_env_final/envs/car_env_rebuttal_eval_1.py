...
class CarlaCVPR04EvalEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.result = cv2.VideoWriter("rollout_ablation_CVPR_04_rebuttals.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
        self.minimap_video = cv2.VideoWriter("minimap_CVPR_04_rebuttals.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
    ...
    def close(self):
        ...
        df.to_csv('task_metrics_ablation_CVPR_04_rebuttals.csv',index=False)
