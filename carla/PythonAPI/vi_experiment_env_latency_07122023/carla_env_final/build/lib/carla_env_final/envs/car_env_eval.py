...
class CarlaEvalEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.model=torch.load("/data/carla/PythonAPI/vi_experiment_env_latency_07122023/model_reg_s1_worst_worst.pth")
        ...
        self.result = cv2.VideoWriter("rollout_ablation_emb_24_02_s1.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
    ...
    def local_policy(self, image, location):
        ...
        res=self.model(img_tensor.to(torch.device('cuda:1')), location_tensor.to(torch.device('cuda:1')))
    ...
    def close(self):
        ...
        df.to_csv('task_metrics_ablation_emb_24_02_s1.csv',index=False)
