...
class CarlaEnvrouter(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.model=torch.load("/data2/kathakoli/carla/PythonAPI/vi_experiment_env_latency_07122023/model_reg_s3_worst_worst.pth")
    ...
    def get_reward(self,collision, action,geodesic,dir_r, energy):
        ...
        if collision!=0 and action[1]>1e-5:
            ...
            #print("Diya")
            #return geodesic_rw
        return (energy_dis*speed*geodesic_rw*extreme_actions_reward)**(1.0/4.0)
