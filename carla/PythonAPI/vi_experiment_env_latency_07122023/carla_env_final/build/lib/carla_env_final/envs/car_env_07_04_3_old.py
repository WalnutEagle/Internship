...
class CarlaEnv6(gym.Env):
    ...
    def expert_policy(self,pedestrian_detected,image,location):
        ...
        res1=self.l.model.stem(img_tensor)
        res1=self.l.model.s1(res1)
        res1=self.l.model.s2(res1)
        res1=self.l.model.s3(res1)
        res1=self.l.model.s4(res1)
        res1=self.l.model.final_conv(res1)
        res1=self.l.model.head.global_pool(res1)
        #res=self.l.feature_extractor(img_tensor)
        loc=self.l.goal(location_tensor)
        #print(res)
        res= torch.cat((res1, loc), dim=1)
