...
class CarlaEnvembs1(gym.Env):
    ...
    def reset(self,seed=None, options=None):
        ...
        self.route_completion=0
        #self.distance_covered=0
        # print(len(self.dense_id_dict['controllers']),"Pedestrians spawned")
        if(self.count>1):
            ...
            self.action_list=np.array([[0.0, 0.0,0.0]])
    ...
    def get_reward(self,collision, action,geodesic,dir_r, energy):
        ...
        if collision!=0 and action[1]>1e-5:
            ...
            # print("Geodesic",geodesic_rw)
                #print(geodesic)
                #speed=(action[0][1])/2x
            energy_dis=(1.0- energy/3.5)#Flop/Max Flop
            print("Energy Reward",energy_dis)
            speed=self.world.player.get_velocity().length()/2
            # print("Speed",speed)
            #print("Diya")
            #return geodesic_rw
        return (geodesic_rw*speed*extreme_actions_reward*energy_dis)**(1.0/4.0)
