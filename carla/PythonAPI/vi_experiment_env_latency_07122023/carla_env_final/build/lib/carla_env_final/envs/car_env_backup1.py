...
class CarlaEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        #self.server=setup1()
        self.client, self.world, self.server,self.minimap, self.state_manager, self.traffic_manager,self.controller,self.display, self.all_id_dict,self.vehicles_list=setup()
        #print(self.s)
    ...
    def reset(self,seed=None, options=None):
        ...
        #print(self.cameras)
        self.sync_mode = CarlaSyncMode(self.world.world,fps=20)
