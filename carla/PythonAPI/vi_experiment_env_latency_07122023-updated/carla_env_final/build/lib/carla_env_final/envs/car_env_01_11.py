...
import math
sys.path.append('/home/kathakoli/carla/PythonAPI/vi_experiment_env_latency_07122023/carla_env_final/carla_env_final/envs/')
...
class CarlaEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.ct=0
        self.prev_angle=0.0
        l=os.listdir('collection_data_final_08_11')
        #l=sorted(l)
        find=[]
        if len(l)==0:
            new_dir='wk_1'
        ...
        if not os.path.exists(str('collection_data_final_08_11/')+str(new_dir)):
            os.makedirs(str('collection_data_final_08_11/')+str(new_dir))
        self.wk_path =str('collection_data_final_08_11/')+str(new_dir)
