...
class CarlaEnvrouterSAC(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.global_model = torch.load("/data/sandesh/carla/PythonAPI/vi_experiment_env_latency_07122023/model_10_11_RegNet.pth")
        #print(self.global_model,"Helloooooo")
        self.model=torch.load("/data/sandesh/carla/PythonAPI/vi_experiment_env_latency_07122023/CVPR_customLinear_21_11_data_08_11_epoch80_lr1emin4_nopretrain_parallel.pth")
    ...
    def observation_space(self, *args, **kwargs):
        ...
        return spaces.Box(low=np.array([-3.14, 0.0,0.0]), high=np.array([3.14, 2.0,1.0]), dtype=np.float32)
        #0.0,, np.inf 
    ...
    def action_space(self):
        ...
        return spaces.Box(low=np.array([0.0]), high=np.array([1.0]), dtype=np.float32)
    ...
    def _get_obs(self):
        ...
        return np.array([collision_detected,distance_covered,r], dtype=np.float32)
        #distance_covered,
    ...
    def get_reward(self,collision, action,geodesic,dir_r, energy):
        ...
        if collision!=0 and action[1]>1e-5:
            ...
            #print("Diya")
            #return geodesic_rw
        return (geodesic_rw*energy_dis*speed*extreme_actions_reward)**(1.0/4.0)
