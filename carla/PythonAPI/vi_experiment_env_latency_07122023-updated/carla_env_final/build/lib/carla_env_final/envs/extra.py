...
class CarlaEvalEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.model=torch.load("/data2/sandesh/carla/PythonAPI/vi_experiment_env_latency_07122023/model_train_final_local_07_11.pth").module
        ...
        self.route_length = self.minimap.planner.get_path_length_from_position(self.start_waypt)
        ...
        self.result = cv2.VideoWriter("supplementary_stuff/scene_2/rollout_ablation_CVPR_04_crowd_path_21_2.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
        self.minimap_video = cv2.VideoWriter("supplementary_stuff/scene_2/minimaps/minimap_CVPR_04_crowd_path_21_2.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
    ...
    def _step(self, action):#0- Local Policy #1- Global Policy
        ...
        for index in range(self.current_wp_index, min(self.current_wp_index+2+1,self.route_length)):
    ...
    def close(self):
        ...
        df.to_csv('supplementary_stuff/scene_2/task_metrics_ablation_CVPR_04_crowd_path_21_2.csv',index=False)
