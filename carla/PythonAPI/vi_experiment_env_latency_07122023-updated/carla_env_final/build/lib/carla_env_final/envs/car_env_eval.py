...
class CarlaEvalEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.ct=0
        self.prev_angle=0.0
        self.global_model = torch.load("/data2/sandesh/carla/PythonAPI/vi_experiment_env_latency_07122023/model_10_11_RegNet.pth")
        self.model=torch.load("/data2/sandesh/carla/PythonAPI/vi_experiment_env_latency_07122023/model_train_final_local_07_11.pth")
        ...
        self.result = cv2.VideoWriter("rollout_ablation_cvpr_07.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
    ...
    def close(self):
        ...
        df.to_csv('task_metrics_ablation_cvpr_07.csv',index=False)
