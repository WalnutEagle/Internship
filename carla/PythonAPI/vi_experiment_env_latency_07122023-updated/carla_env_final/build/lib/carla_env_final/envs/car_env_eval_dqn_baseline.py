...
class DQNEvalEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        #CVPR_customLinear_21_11_data_08_11_epoch80_lr1emin4_nopretrain_normal
        self.model = torch.load("/data/sandesh/carla/PythonAPI/vi_experiment_env_latency_07122023/local_model_10_11_mobilenet.pth")
        ...
        self.result = cv2.VideoWriter("new_experiments/dqn_baseline/high_setup/rollout_ablation_DQN_baseline_path_21_new.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
        self.minimap_video = cv2.VideoWriter("new_experiments/dqn_baseline/high_setup/minimaps/minimap_DQN_baseline_path_21_new.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
    ...
    #print(p)
        ...
        #print(p)
            ...
            self.task_metrics.append([self.destination_success,(self.percentage_route_completion*(0.5**(self.infraction_ped_collision/(self.route_length*self.percentage_route_completion/1000.0)))*(1-(self.energy_consumption/(1.65*(self.local_step_counter+self.global_step_counter))))), self.infraction_ped_collision,self.energy_consumption,self.total_latency,self.percentage_route_completion, self.route_deviation, self.route_length*self.percentage_route_completion/100000.0, episode_time, self.local_step_counter, self.global_step_counter])
            # self.episode_start_time = time.time()
            #print("Energy",)
    ...
    def close(self):
        ...
        df.to_csv('new_experiments/dqn_baseline/high_setup/task_metrics_ablation_DQN_baseline_path_21_new.csv',index=False)
