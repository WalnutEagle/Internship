...
class CarlaEnv(gym.Env):
    ...
    def _get_obs(self):
        ...
        print("Collision history :",self.world.collision_sensor.get_collision_history())
    ...
    def _step(self, action):#0- Local Policy #1- Global Policy
        ...
        obs = self._get_obs()#collision, pedestrian, distance_covered
        ...
        if done or truncated:
            ...
            self.task_metrics.append([self.count_epi,len(self.world.collision_sensor.get_collision_history()),self.route_completion])
            #print("Energy",)
