...
def setup1():
    ...
    env["CARLA_ROOT"]="/data/sandesh/carla/Unreal/CarlaUE4/Saved/StagedBuilds/LinuxNoEditor/"
...
def setup(
    ...
    argparser.add_argument(
        '--path',
        default="/data/sandesh/carla/PythonAPI/vi_experiment_env_latency_07122023/demo_rh/path_points_t10_32_95.npy",
        type=str,
    ...
    val1=util.spawn_walkers_dense(client, world.world, 15, loc_center,0, 0.9, 0.2, dense_id_dict, dest_points)
    if not val1:
