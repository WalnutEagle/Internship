...
from carla_env_final.envs.CarlaEnvSetup import setup,setup1, docker_setup
...
class CarlaEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.task_metrics=[]
        self.count_epi=0
        self.expert_policy_list=np.array([[0, 0] for _ in range(10)])
    ...
    def expert_policy(self,pedestrian_detected):
        ...
        return self.expert_policy_list[-10:]
    ...
    def _get_obs(self):
        ...
        # print(collision_detected,"Col")
        # print(pedestrian_detected,"Ped")
    ...
    def reset(self,seed=None, options=None):
        ...
        self.route_completion=0
        #self.distance_covered=0
        # print(len(self.dense_id_dict['controllers']))
        # self.dense_id_dict.update(self.sparse_id_dict)
        # print(len(self.dense_id_dict['controllers']))
        if(self.count>1):
            ...
            #     # self.world.world.get_actor(_id).start()
            #     print(self.world.world.get_actor(_id).get_transform(),'New Location')
            # location_flag = self.count % 2
            # location_flag=1
            # print("Changing sparse direction")
            # # Change direction of sparse walkers
            ...
            # # transforms = [carla.command.ApplyWalkerState(actor_id, x[0],0.0) for actor_id, x in zip(self.dense_id_dict['walkers'], self.dense_id_dict['locations'])]
            # # self.client.apply_batch(transforms)
            # # #self.client.apply_batch([carla.command.ApplyTransform(x[0])
            # # #                for x in self.dense_id_dict['locations']])
            # # self.world.tick(self.clock)
            # # for _id in self.dense_id_dict['controllers']:
            # #     # self.world.world.get_actor(_id).stop()
            ...
            # #     print(self.world.world.get_actor(_id).get_transform(),'New Location')
            #     # location=
            #     # self.world.world.get_actor(_id).go_to_location(location[1])
            # for i in range(len(self.sparse_id_dict['controllers'])):
            #     actor = self.world.world.get_actor(self.sparse_id_dict['walkers'][i])
            #     location = self.sparse_id_dict['locations'][i]
            ...
            #     controller = self.world.world.get_actor(self.sparse_id_dict['controllers'][i])
            #     controller.stop()
            #     actor.set_location(location[0])
                
            #     controller.start()
            #     # print(m)
            #     controller.go_to_location(location[location_flag])
            
            # print("Changing dense direction")
            # #Change direction of dense walkers
            # for i in range(len(self.dense_id_dict['controllers'])):
            #     actor = self.world.world.get_actor(self.dense_id_dict['walkers'][i])
            #     location = self.dense_id_dict['locations'][i]
            #     print(actor.get_transform(),'Before new  location')
            #     # controller = self.world.world.get_actor(self.dense_id_dict['controllers'][i])
            #     controller.stop()
            #     print(actor)
            #     print(location[0])
            ...
            #     #self.world.resume()
            #     #print(actor.get_location(),location[0],"Hi")
                
            #     # print(m)
            # self.world.tick(self.clock)
            # for i in range(len(self.dense_id_dict['controllers'])):
            #     actor = self.world.world.get_actor(self.dense_id_dict['walkers'][i])
            #     actor.set_location(location[0].location)
            #     #actor.set_rotation(location[0].rotation)
            # self.world.tick(self.clock)
            # for i in range(len(self.dense_id_dict['controllers'])):
            #     actor = self.world.world.get_actor(self.dense_id_dict['walkers'][i])
            #     location = self.dense_id_dict['locations'][i]
            ...
            #     print(actor)
            #     print(location[0])
            #     print(actor.get_transform(),'After new location')
            #     controller.start()
            #     controller.go_to_location(location[location_flag])
                #print(actor.get_location(),location[0])
            # for _id in self.all_id_dict['controllers']:
            #     self.world.world.get_actor(_id).stop()
            ...
            loc_center = [player_location.location.x, player_location.location.y, player_location.location.z ]
            # self.val=util.spawn_walkers_dense(self.client, self.world.world, 30, loc_center,0, 0.9, 0.2, self.all_id_dict)
            # if not self.val:
            #     print("spawn_walkers_dense failed")
            #     return
