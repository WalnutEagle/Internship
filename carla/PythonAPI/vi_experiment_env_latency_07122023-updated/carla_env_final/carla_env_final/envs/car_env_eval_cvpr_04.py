...
class Weather(object):
    ...
    def tick(self):
        ...
        # self._storm.tick(delta_seconds)transform
...
class CarlaEvalCVPR04Env(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.result = cv2.VideoWriter("new_experiments/cvpr_04/high_setup/rollout_ablation_cvpr_04.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
        self.minimap_video = cv2.VideoWriter("new_experiments/cvpr_04/high_setup/minimaps/minimap_cvpr_04_high.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
    ...
    def local_policy(self, image, location):
        ...
        res,ft=self.model(img_tensor, location_tensor)
    ...
    def close(self):
        ...
        df.to_csv('new_experiments/cvpr_04/high_setup/task_metrics_ablation_cvpr_04.csv',index=False)
