...
class CarlaEvalEnv(gym.Env):
    ...
    def __init__(self, args,vehicles_list,all_id_dict):
        ...
        self.result = cv2.VideoWriter("rollout_ablation_residual_ppo.avi",cv2.VideoWriter_fourcc(*'MJPG'),20,(640,360))
    ...
    def _step(self, action):#0- Local Policy #1- Global Policy
        ...
        #print(p)
            ...
            print("New route completion: ", route_completion)
    ...
    def close(self):
        ...
        df.to_csv('task_metrics_ablation_residual_ppo.csv',index=False)
