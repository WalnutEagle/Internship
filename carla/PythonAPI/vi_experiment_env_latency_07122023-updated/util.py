...
def spawn_vehicles(client, world, number_of_vehicles, synchronous_master, traffic_manager, car_lights_on=False, is_move=True):
    ...
    for n, transform in enumerate(spawn_points):
        ...
        batch.append(SpawnActor(blueprint, transform)
            .then(SetAutopilot(FutureActor, is_move, traffic_manager.get_port())))
    ...
    print("Number of vehicles failed to spawn: ", count)
