...
from local_model_22_11_least import ClassificationV250Network
...
def train(data_folder, save_path):
    ...
    infer_action = ClassificationV250Network()
    ...
    plt.savefig('/data2/kathakoli/carla/PythonAPI/vi_experiment_env_latency_07122023/Loss_Plot_22_11_least.jpg')#saving the plot
