...
from local_model_22_11_less import ClassificationV3smallNetwork
...
def train(data_folder, save_path):
    ...
    infer_action = ClassificationV3smallNetwork()
    ...
    plt.savefig('/data2/kathakoli/carla/PythonAPI/vi_experiment_env_latency_07122023/Loss_Plot_22_11_less.jpg')#saving the plot
