...
# from local_model_divide import ClassificationNetworkDivide
...
#     infer_action = ClassificationNetworkDivide()
#     # infer_action1=nn.DataParallel(infer_action)
#     infer_action.to(device)
#     infer_action.requires_grad = True
#     #optimizer = torch.optim.Adam(infer_action.parameters(), lr=0.0002)#Change
...
#     plt.savefig('/data2/kathakoli/carla/PythonAPI/vi_experiment_env_latency_07122023/Loss_Plot_Local_Model_13_11.jpg')#saving the plot
