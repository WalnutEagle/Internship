...
from local_model_22_11_more import ClassificationV2moreNetwork
...
def train(data_folder, save_path):
    ...
    infer_action = ClassificationV2moreNetwork()
    ...
    plt.savefig('/data2/kathakoli/carla/PythonAPI/vi_experiment_env_latency_07122023/Loss_Plot_22_11_more.jpg')#saving the plot
