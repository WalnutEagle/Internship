...
VEHICLES=(200 200 200 200 200)
WALKERS=(300 300 300 300 300)
EPOCHS=(20 20 20 20 20)
CUDAID=(0 1 1 2 3)

# env setting
CARLA_ROOT=/data2/zanming/XWORLD/carla
PYTHON_SCRIPT=$CARLA_ROOT/PythonAPI/data_collection_xworld/collect_data_xworld_withmesh_2023.py
ENV_SETUP_SCRIPT=$CARLA_ROOT/load_carla_env_variable.sh
CARLA_SCRIPT=$CARLA_ROOT/start_carla_server_docker.sh
START_SCRIPT=./carla/StagedBuilds/LinuxNoEditor/CarlaUE4.sh
