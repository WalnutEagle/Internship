...
# session setting
SESSION_N=4
TOWNS=('Town05' 'Town10HD' 'Town05' 'Town10HD')
VEHICLES=(200 200 200 200)
WALKERS=(300 300 300 300)
EPOCHS=(20 20 20 20)
CUDAID=(2 2 3 3)

# env setting
CARLA_ROOT=/data2/zanming/carla
PYTHON_SCRIPT=$CARLA_ROOT/PythonAPI/data_collection_xworld/collect_data_xworld_withmesh_test_asset.py
ENV_SETUP_SCRIPT=$CARLA_ROOT/load_carla_env_variable.sh
CARLA_SCRIPT=$CARLA_ROOT/start_carla_server_docker.sh
START_SCRIPT=$CARLA_ROOT/LinuxNoEditor/CarlaUE4.sh
DOCKER_NAME=carla_py3p8_docker:w_test_asset
